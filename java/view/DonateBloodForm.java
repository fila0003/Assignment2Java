...
public class DonateBloodForm extends HttpServlet {
    ...
    protected void processRequest( HttpServletRequest request, HttpServletResponse response )
        ...
        try( PrintWriter out = response.getWriter() ) {
            ...
            out.println( "<div style=\"display: border; border-style:solid; inline-block;\">" );
            out.println( "<form method=\"post\">" );
            out.println( "<table  style=\"width:80%,margin=5px;\">" );
            out.println( "<header> PERSON </header>");
            out.println( "<br>");
            out.println( "<tr>");
            out.println( "<th>");
            ...
            out.printf( "<input type=\"datetime-local\" step=1 name=\"%s\"  min=\"1900-01-01\" max=\"2007-12-30\"><br>", PersonLogic.BIRTH);
            out.println( "</td>" );
             out.println( "</tr>");
    ...
    protected void doPost( HttpServletRequest request, HttpServletResponse response )
        ...
        if( pLogic.getPersonWithLastName(lastName).isEmpty() ){
            try {
            ...
            errorMessage = "Last Name: \"" + lastName + "\" already exists";
        }
